...
[Download the latest release (version 2.0.1)](https://raw.githubusercontent.com/peter88213/yw-renumber/main/dist/yw-renumber_v2.0.1.zip)

- Unzip the downloaded zipfile "yw-renumber_v2.0.1.zip" into a new folder.
