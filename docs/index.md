...
[Download the latest release (version 0.3.3)](https://raw.githubusercontent.com/peter88213/yw-renumber/main/dist/yw-renumber_v0.3.3.zip)

- Unzip the downloaded zipfile "yw-renumber_v0.3.3.zip" into a new folder.
