...
[Download the latest release (version 2.4.6)](https://raw.githubusercontent.com/peter88213/yw-renumber/main/dist/yw-renumber_v2.4.6.zip)

- Unzip the downloaded zipfile "yw-renumber_v2.4.6.zip" into a new folder.
