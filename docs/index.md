...
[Download the latest release (version 0.2.4)](https://raw.githubusercontent.com/peter88213/yw-renumber/main/dist/yw-renumber_v0.2.4.zip)

- Unzip the downloaded zipfile "yw-renumber_v0.2.4.zip" into a new folder.
